                    ...
                    <div class="flex flex-col md:flex-row justify-between items-start gap-6 mb-8 relative z-10 print:flex-row print:mb-6">
                        <div>
                            ...
                            <p class="text-sm text-gray-500 mt-2 flex items-center">
                                <span class="mr-2 no-print">📅</span> Tanggal Kirim: <strong class="ml-1 text-gray-700"><?php echo e(\Carbon\Carbon::parse($order->delivery_date)->translatedFormat('d F Y')); ?></strong>
                            </p>
                        </div>
                        <div class="flex flex-wrap md:flex-col gap-3 print:items-end">
                            <span class="px-6 py-2 rounded-xl text-[10px] font-black tracking-widest text-center shadow-sm <?php echo e($order->payment_status == 'PAID' || $order->payment_status == 'LUNAS' ? 'bg-green-500 text-white' : 'bg-orange-400 text-white'); ?> print:text-black print:border print:border-gray-300">
                                STATUS BAYAR: <?php echo e($order->payment_status); ?>
                            ...
                            <span class="px-6 py-2 rounded-xl text-[10px] font-black tracking-widest text-center bg-gray-100 text-gray-600 shadow-sm border border-gray-200 print:text-black">
                                STATUS ORDER: <?php echo e($order->order_status); ?>
                    ...
                    <div class="border-t border-dashed border-gray-200 pt-8 print:pt-4">
                        ...
                        <div class="space-y-4">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $order->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="group bg-gray-50/50 p-5 rounded-2xl border border-transparent flex justify-between items-start print:bg-white print:border-b print:rounded-none print:px-0">
                                    <div class="flex-grow">
                                        <p class="font-bold text-gray-800 text-lg"><?php echo e($item->item_name); ?></p>
                                        ...
                                        <div class="mt-2">
                                            ...
                                            <ul class="text-xs text-gray-600 italic space-y-1 list-disc ml-4">
                                                ...
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(is_array($item->side_dish)): ?>
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $item->side_dish; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lauk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <li><?php echo e($lauk); ?></li>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                <?php elseif(!empty($item->side_dish)): ?>
                                                    
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = explode(',', $item->side_dish); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lauk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <li><?php echo e(trim($lauk)); ?></li>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                <?php else: ?>
                                    ...
                                    <div class="text-right ml-4">
                                        ...
                                        <p class="text-[10px] text-gray-400 font-medium">
                                            Rp <?php echo e(number_format($item->price, 0, ',', '.')); ?> / box
                                        </p>
                        ...
                        <div class="mt-10 p-8 bg-gray-900 rounded-[2rem] text-white flex flex-col md:flex-row justify-between items-center gap-4 print:bg-white print:text-black print:border-t-2 print:border-gray-900 print:rounded-none print:mt-6 print:px-0">
                            <div>
                                ...
                                <p class="text-3xl font-bold text-primary italic font-inter print:text-black print:not-italic">Rp <?php echo e(number_format($order->total_price, 0, ',', '.')); ?></p>
                            </div>
