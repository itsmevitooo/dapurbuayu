    ...
    <div x-data="{ openReview: false }">
                        ...
                        <div class="swiper-slide">
                            <div class="bg-white rounded-xl shadow-xl overflow-hidden border-t-8 border-primary flex flex-col w-full">
                                ...
                                <div class="p-6 flex flex-col flex-grow font-inter">
                                    <h3 class="text-xl font-bold mb-3 text-gray-800 uppercase tracking-tight"><?php echo e($package->name); ?></h3>
                                    <div class="flex-grow">
                                    ...
                                    <div class="mt-4 pt-4 border-t border-gray-100 font-inter">
                                        <p class="text-2xl font-black text-primary mb-4 text-center italic">Rp <?php echo e(number_format($package->price, 0, ',', '.')); ?></p>
                                        <a href="<?php echo e(route('paket.detail', $package->id)); ?>" class="block w-full bg-primary text-white font-bold py-3 rounded-full text-center uppercase text-[10px] tracking-widest transition-all hover:bg-yellow-600">Pilih Paket</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="bg-white p-6 rounded-lg shadow-lg border-t-4 border-primary flex flex-col h-full w-full font-inter">
                                ...
                                <p class="italic text-gray-700 mb-3 flex-grow text-sm md:text-base leading-relaxed">"<?php echo e($review->comment); ?>"</p>
                                <small class="font-bold text-gray-600 uppercase border-t pt-3 tracking-widest text-[10px]">- <?php echo e($review->name); ?></small>
                            </div>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
        ...
        <div x-show="openReview" 
            ...
            <div @click.away="openReview = false" class="bg-white w-full max-w-md rounded-2xl shadow-2xl p-8">
                ...
                <form action="<?php echo e(route('reviews.store')); ?>" method="POST" enctype="multipart/form-data" class="space-y-4 font-inter">
                    <?php echo csrf_field(); ?>
                    <div>
