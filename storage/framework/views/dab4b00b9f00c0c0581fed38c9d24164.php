...
<?php $__env->startSection('content'); ?>
    <div x-data="{ openReview: <?php echo e($errors->any() ? 'true' : 'false'); ?> }">
        ...
        <section class="relative h-120 bg-cover bg-center shadow-xl mb-12" style="background-image: url('<?php echo e($bannerUrl . '?v=' . time()); ?>');">
        ...
        <section id="packages" class="mb-12 py-10 bg-yellow-50 rounded-xl shadow-inner border border-yellow-100">
            ...
            <div class="max-w-7xl mx-auto px-4 relative">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8 py-4">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $packages->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $package): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="bg-white rounded-xl shadow-xl overflow-hidden border-t-8 border-primary flex flex-col h-full relative group w-full">
                        ...
                        <div class="h-48 overflow-hidden">
                            <img src="<?php echo e(asset('storage/' . $package->image) . '?v=' . time()); ?>" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110">
                        </div>
                        <div class="p-6 flex flex-col flex-grow font-inter bg-white justify-between">
                            <div>
                                <h3 class="text-lg font-bold mb-3 text-gray-800 uppercase tracking-tight h-14 line-clamp-2"><?php echo e($package->name); ?></h3>
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($imgs)): ?>
                                        <div class="flex gap-2 mb-4 overflow-x-auto pb-1">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = array_slice((array)$imgs, 0, 3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <img src="<?php echo e(asset('storage/' . ltrim($img, '/')) . '?v=' . time()); ?>" class="w-12 h-12 object-cover rounded-lg border border-gray-100 shadow-sm flex-shrink-0" onerror="this.src='https://placehold.co/100x100?text=Error'">
                ...
                <form action="<?php echo e(route('reviews.store')); ?>" method="POST" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div class="space-y-5 text-left font-inter">
                        <div>
                            ...
                            <input type="text" name="name" value="<?php echo e(old('name')); ?>" required class="w-full border-gray-200 rounded-xl p-3 focus:ring-yellow-500 focus:border-yellow-500" placeholder="Masukkan nama Anda">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div>
                            ...
                            <select name="paket_id" required class="w-full border-gray-200 rounded-xl p-3 focus:ring-yellow-500 focus:border-yellow-500">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $packages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $package): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><option value="<?php echo e($package->id); ?>" <?php echo e(old('paket_id') == $package->id ? 'selected' : ''); ?>><?php echo e($package->name); ?></option><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </select>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['paket_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><span class="text-red-500 text-xs"><?php echo e($message); ?></span><?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div>
                            ...
                            <textarea name="comment" rows="4" required class="w-full border-gray-200 rounded-xl p-3 focus:ring-yellow-500 focus:border-yellow-500" placeholder="Ceritakan pengalaman Anda..."><?php echo e(old('comment')); ?></textarea>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="flex items-center justify-end gap-6 pt-4">
                        ...
                        <button type="submit" class="bg-slate-800 hover:bg-slate-900 text-white font-bold py-3 px-10 rounded-full text-xs uppercase tracking-widest shadow-md transform transition active:scale-95 btn-hover-anim">Kirim Review</button>
                    </div>
                </form>
            </div>
        </div>
