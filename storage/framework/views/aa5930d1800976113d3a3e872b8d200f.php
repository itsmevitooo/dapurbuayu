...
<div class="max-w-4xl mx-auto px-4 py-20 text-center">
    <div class="bg-white p-12 rounded-[3rem] shadow-2xl border border-gray-100">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="<?php echo e(route('home')); ?>" class="px-8 py-4 bg-gray-900 text-white font-black rounded-2xl hover:bg-black transition-all shadow-xl">
                KEMBALI KE BERANDA
            </a>
            <a href="<?php echo e(route('check_order.index')); ?>" class="px-8 py-4 bg-primary text-white font-black rounded-2xl hover:bg-yellow-600 transition-all shadow-xl shadow-yellow-100">
                CEK STATUS PESANAN
            </a>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\dapurbuayu\resources\views/paymentsuccess.blade.php ENDPATH**/ ?>