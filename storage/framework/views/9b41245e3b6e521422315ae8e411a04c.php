...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.button.index','data' => ['type' => 'submit','size' => 'md']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['type' => 'submit','size' => 'md']); ?>
                Simpan Perubahan
...
<?php endif; ?><?php /**PATH C:\laragon\www\dapurbuayu\resources\views/filament/pages/manage-settings.blade.php ENDPATH**/ ?>