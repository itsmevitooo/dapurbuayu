...
<?php $__env->startSection('title', 'Kebijakan Privasi - Dapur Bu Ayu'); ?>
...
<div class="max-w-[80%] mx-auto px-4 py-12">
    <div class="text-center mb-12">
        <h2 class="text-6xl font-bold text-primary font-qwitcher">Kebijakan Privasi</h2>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\dapurbuayu\resources\views/legal/privacy.blade.php ENDPATH**/ ?>