...
<div class="container mx-auto py-10 px-4">
    ...
    <div class="bg-white p-8 rounded-xl shadow-2xl max-w-4xl mx-auto mb-20">
        ...
        <div class="flex justify-center">
            <a href="{{ $data['google_maps_url'] ?? '#' }}" target="_blank" class="bg-primary hover:bg-yellow-600 text-white font-bold py-3 px-8 rounded-lg shadow-md transition duration-300 uppercase text-xs tracking-widest">
                Buka di Google Maps
            </a>
        </div>
    </div>
